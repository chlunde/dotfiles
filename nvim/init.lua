...
require('lazy').setup({
            ...
            plugins = {
              {
                ...
                location = home .. '/.npm/lib/node_modules/@vue/typescript-plugin',
...

  {
    ...
    config = function()
      -- Mini Sessions is a plugin that allows you to save and restore your
      -- current session, including open buffers, window layout, etc.
      --
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      local function treesitter_try_attach(buf, language)
        ...
        -- If there is no indent query, fall back to vim's built-in indentexpr.
